  ...
  const products = [
    {
      ...
      description: "Elegant diamond engagement ring with matching wedding band, featuring brilliant cut stones"
    },
    {
      id: 2,
      ...
      <section className="max-w-[100rem] mx-auto px-4 sm:px-6 md:px-8 mt-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {products.map((product) => (
            <article key={product.id} className="border border-gray-200 rounded-lg p-4 flex flex-col hover:shadow-lg transition-shadow">
              ...
              <div className="mt-3 flex items-center justify-between text-gray-500 text-sm">
                ...
                <button 
                  className="flex items-center space-x-1 border border-gray-300 rounded-md px-3 py-1 text-xs hover:bg-gray-100 transition-colors"
                  onClick={addToCart}
                >
