...
const BridalDress = () => {
  ...
  const bridalDresses = [
    {
      ...
      title: 'Swarovski Embellished Sweet Heart Neck, Ruffled Train Mermaid Bridal Gown/Dress',
  ...
  const toggleFavorite = (e, dressId) => {
    e.stopPropagation();
    e.preventDefault();
    setFavorites(prev => {
      ...
      <section className="px-6 mt-10 max-w-[100rem] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {allDresses.map((dress) => {
            const routePath =
              dress.type === "Rent"
                ? `/productdetail-rent/${dress.id}`
                : dress.type === "Auction"
                ? `/productdetail-auction/${dress.id}`
                : `/productdetail-buy/${dress.id}`;
                ...
                >
                  ...
                  <div className="flex justify-between items-center mt-auto text-gray-600 text-sm">
                    ...
                    <button 
                      ...
                      onClick={(e) => handleAddToCart(e, dress)}
                    >
