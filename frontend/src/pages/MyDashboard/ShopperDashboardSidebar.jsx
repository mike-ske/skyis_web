...
import { X, Home, Package, ShoppingCart, Clock, Heart, Users, Bell, Settings } from 'lucide-react';

const ShopperDashboadSidebar = ({ 
  sidebarOpen, 
  setSidebarOpen, 
  menuItems = null
}) => {
  ...
  // Replace the entire useEffect with this simpler version:
useEffect(() => {
  const path = location.pathname;
  const pathSegments = path.split('/');
  const lastSegment = pathSegments[pathSegments.length - 1];
  
  // Map path segments to menu IDs
  const pathToIdMap = {
    'overview': 'overview',
  ...
  setCurrentActive(pathToIdMap[lastSegment] || 'overview');
}, [location.pathname]);
  ...
  const defaultMenuItems = [
    ...
    { 
      ...
      icon: Package, 
      label: 'Listings', 
      href: '/shopperdashboard/shopper-listings',
      badge: null 
    },
    { 
      id: 'orders', 
    ...
    { 
      ...
      icon: Heart, 
      label: 'Wishlist', 
      href: '/shopperdashboard/wishlist',
      badge: null 
    },
    { 
      id: 'following', 
      icon: Users, 
      label: 'Following', 
      href: '/shopperdashboard/following',
      badge: null 
    },
    { 
      id: 'notifications', 
      icon: Bell, 
      label: 'Notifications', 
      href: '/shopperdashboard/notifications',
      badge: null 
    },
    { 
      id: 'settings', 
      icon: Settings, 
      label: 'Settings', 
      href: '/shopperdashboard/settings',
      badge: null 
    }
  ];
...
export default ShopperDashboadSidebar;